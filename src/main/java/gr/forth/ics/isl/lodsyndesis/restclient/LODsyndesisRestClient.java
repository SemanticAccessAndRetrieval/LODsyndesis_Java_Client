...
public class LODsyndesisRestClient {
    ...
    public int getCardinalityAsJSON(String uri,boolean print) {
        try {
            ...
            String card=allQuads.get(0).get(0).split(",")[0].split(":")[1];
            int cardinality=Integer.parseInt(card);
            if(print==true){
                System.out.println("Frequency of "+uri+" "+cardinality+"\n\n");
            }
            return cardinality;
        } catch (IOException ex) {
            Logger.getLogger(LODsyndesisRestClient.class.getName()).log(Level.SEVERE, null, ex);
     ...
     * @return Triples of sameAs entities
     */
    public String datasetDiscoveryEntities(String uris,int subset,int topK, String mtype,boolean print) {
        try {
    ...
    public static void main(String[] args) {
        ...
        //Entity Frequency of Aristotle
        chanel.getCardinalityAsJSON(URI,print);
        
        //Provenance of an Entity
        String URI2 = "http://dbpedia.org/resource/Aristotle";
        chanel.allDatasets(URI2, print);
        
        //All Values for an entity
        String entity1 = "http://dbpedia.org/resource/Dimitris_Diamantidis";
        ...
        //Entity Based Dataset Discovery for Aristotle and Socrates
        String uris="http://dbpedia.org/resource/Aristotle%20http://dbpedia.org/resource/Socrates";
        int datasetsNumber=5;
        int topK=10;
        String measurement="coverage";
        chanel.datasetDiscoveryEntities(uris,5,10,measurement,print);
